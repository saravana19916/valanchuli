...
<?php 
    ...
    $division_slug = get_query_var('division_slug');

    if ($division_slug) {
        $divisionObj = get_term_by('slug', $division_slug, 'division');
        ...
        if ($divisionObj) {
            ...
            if ($division_query->have_posts()) {
                while ($division_query->have_posts()) {
                    $division_query->the_post();
                    $post_id = get_the_ID();
            ...
            usort($division_stories, function ($a, $b) {
