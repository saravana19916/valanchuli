<?php
    ...
    $katturaiUrl = add_query_arg([
        'context' => $context,
        'user_id'  => $current_user
    ], get_permalink(get_page_by_path('katturai')));
?>

<div class="d-flex justify-content-between align-items-center mt-4">
    <h4 class="py-2 fw-bold m-0">🔥 கட்டுரை</h4>
    <a href="<?php echo esc_url($katturaiUrl); ?>" class="text-primary-color fs-16px">
